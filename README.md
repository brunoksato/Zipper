...
- for Laravel 5: `"Sfma/zipper": "1.0.x"`
- ~~for Laravel 4: `"Sfma/zipper": "0.5.x"`~~

2. Run `composer update`

3. Go to `app/config/app.php`

- add to providers `Sfma\Zipper\ZipperServiceProvider::class`
- add to aliases `'Zipper' => Sfma\Zipper\Zipper::class`
